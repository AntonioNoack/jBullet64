...
public interface IDebugDraw {
    ...
    void drawLine(Vector3d from, Vector3d to, Vector3d color);

    default void drawTriangle(Vector3d v0, Vector3d v1, Vector3d v2, Vector3d n0, Vector3d n1, Vector3d n2, Vector3d color, double alpha) {
        drawTriangle(v0, v1, v2, color, alpha);
    }

    default void drawTriangle(Vector3d v0, Vector3d v1, Vector3d v2, Vector3d color, double alpha) {
        drawLine(v0, v1, color);
        drawLine(v1, v2, color);
        drawLine(v2, v0, color);
    }

    void drawContactPoint(Vector3d PointOnB, Vector3d normalOnB, double distance, int lifeTime, Vector3d color);

    void reportErrorWarning(String warningString);

    void draw3dText(Vector3d location, String textString);

    void setDebugMode(int debugMode);

    int getDebugMode();

    default void drawAabb(Vector3d from, Vector3d to, Vector3d color) {
